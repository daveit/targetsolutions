class StaticPagesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @static_page.save
        format.html { redirect_to static_pages_path, notice: 'Static page was successfully created.' }
  ...
  private
    ...
    def static_page_params
      params.require(:static_page).permit(:name, :shortcode, :body, :left, :right, :lefton, :righton)
    end
end
